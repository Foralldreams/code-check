...
//        System.out.println(className);
    ...
    public void visitVariable(VariableTree tree) {
        ...
        if (tree.symbol().isFinal()) {
            //如果字符串大于10时，且没有按照_进行分割，报错z
            if (varibaleName.length() > 10 && !varibaleName.contains("_")) {
                System.out.println("Warnning:  Class<" + className + ">#ConstantParam<" + varibaleName + ">" + "Length of Parameter is too long");
            ...
            if (count > 0) {
                ...
                System.out.println("Warnning:  Class<" + className + ">#ConstantParam<" + varibaleName + ">" + "Parameter contain digits");
            ...
            if (i > 0) {
                ...
                System.out.println("Warnning:  Class<" + className + ">#ConstantParam<" + varibaleName + ">" + "Parameter is not upcase");
